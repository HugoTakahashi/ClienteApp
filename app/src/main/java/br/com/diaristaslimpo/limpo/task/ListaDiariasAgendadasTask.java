 ...
 */
public class ListaDiariasAgendadasTask extends AsyncTask<String, Void, JSONArray> {
    private Context context;
    private ProgressDialog dialog;
    public AsyncResponse delegate = null;

    public ListaDiariasAgendadasTask(Context context) {
    ...
    protected JSONArray doInBackground(String... params) {
        ...
        String url = context.getResources().getString(R.string.url_prefix) +
                context.getResources().getString(R.string.url_lista_diaria_agendada);
