...
public class TelaSExibeDiarista extends AppCompatActivity {
        ...
        switch (item.getItemId()){
            case R.id.menu_enviar_cadastro:
                ...
                if(idDiaristasSelecionadas.size() == 0){
                    MessageBox.show(this, "Erro", "Selecione pelo menos uma diarista");
                } else {

                    Intent intent = new Intent(at, TelaSConfirmacaoServico.class);
